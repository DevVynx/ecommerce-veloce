...
const body = z.object({
  code: z.string().min(1, "Informe um código.").max(15, "Código muito longo.").transform((s) => s.toUpperCase()),
  ...
  usageLimitPerUser: z.number().int().positive("Limite por usuário deve ser positivo.").optional().default(1),

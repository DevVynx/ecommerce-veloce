...
const templates: Record<CategoryName, CategoryTemplate> = {
  Eletrônicos: {
    ...
    lines: [
      ...
      { name: "UltraFine Monitor 32\" 4K", weight: 5.0, priceMin: 3500, priceMax: 6000 },
      { name: "WH-1000XM Wireless Headphone", weight: 0.25, priceMin: 1200, priceMax: 2100 },
      { name: "MX Master Wireless Mouse", weight: 0.14, priceMin: 250, priceMax: 400 },
      ...
      { name: "Galaxy Watch 7 BT", weight: 0.06, priceMin: 1200, priceMax: 2800 },
      { name: "XPS 16 Intel Ultra 9", weight: 1.9, priceMin: 8000, priceMax: 15000 },
      { name: "UltraGear 27\" 240Hz", weight: 4.5, priceMin: 1500, priceMax: 3500 },
  ...
  Masculino: {
    ...
    lines: [
      { name: "Dri-FIT Running T-Shirt", weight: 0.15, priceMin: 80, priceMax: 180 },
      { name: "501 Original Fit Jeans", weight: 0.5, priceMin: 200, priceMax: 450 },
      { name: "Essentials French Terry Jogger", weight: 0.4, priceMin: 150, priceMax: 300 },
      { name: "Club Cotton T-Shirt", weight: 0.18, priceMin: 60, priceMax: 150 },
      { name: "Sportswear Windrunner Jacket", weight: 0.35, priceMin: 250, priceMax: 500 },
      { name: "Classic Fit Chino Pants", weight: 0.45, priceMin: 180, priceMax: 350 },
      { name: "Performance Polo Shirt", weight: 0.2, priceMin: 100, priceMax: 220 },
      { name: "Ultimate Flex Shorts", weight: 0.15, priceMin: 80, priceMax: 160 },
      { name: "Heritage Crewneck Sweater", weight: 0.4, priceMin: 200, priceMax: 400 },
      { name: "Down Vest Lightweight", weight: 0.3, priceMin: 300, priceMax: 600 },
      { name: "Racer TR21 Training Shoes", weight: 0.35, priceMin: 250, priceMax: 500 },
    ],
  ...
  Feminino: {
    ...
    lines: [
      { name: "Tailored Blazer", weight: 0.4, priceMin: 250, priceMax: 600 },
      { name: "Essential Crop Top", weight: 0.1, priceMin: 50, priceMax: 120 },
      { name: "Mom Fit High-Waist Jeans", weight: 0.45, priceMin: 180, priceMax: 350 },
      { name: "Oversized Hoodie", weight: 0.35, priceMin: 120, priceMax: 250 },
      { name: "Pleated Mini Skirt", weight: 0.2, priceMin: 100, priceMax: 220 },
      { name: "Floral Maxi Dress", weight: 0.3, priceMin: 150, priceMax: 350 },
      { name: "Leather Moto Jacket", weight: 0.5, priceMin: 400, priceMax: 800 },
      { name: "Cotton Pajama Set", weight: 0.25, priceMin: 80, priceMax: 180 },
      { name: "Trench Coat Long", weight: 0.6, priceMin: 350, priceMax: 700 },
      { name: "Biker Shorts 2-in-1", weight: 0.12, priceMin: 60, priceMax: 130 },
      { name: "Knit Cardigan Oversized", weight: 0.3, priceMin: 150, priceMax: 300 },
    ],
  ...
  Joias: {
    ...
    lines: [
      { name: "Sterling Silver Heart Pendant", weight: 0.01, priceMin: 500, priceMax: 3000 },
      { name: "Snake Chain Bracelet", weight: 0.015, priceMin: 300, priceMax: 1500 },
      { name: "Crystal Drop Earrings", weight: 0.005, priceMin: 200, priceMax: 1000 },
      { name: "Love Ring 18k", weight: 0.008, priceMin: 800, priceMax: 5000 },
      { name: "Tennis Bracelet", weight: 0.02, priceMin: 1000, priceMax: 8000 },
      { name: "Pearl Stud Earrings", weight: 0.003, priceMin: 300, priceMax: 1200 },
      { name: "Diamond Solitaire Necklace", weight: 0.01, priceMin: 2000, priceMax: 12000 },
      { name: "Gold Hoop Earrings", weight: 0.012, priceMin: 400, priceMax: 2000 },
      { name: "Cocktail Ring", weight: 0.01, priceMin: 600, priceMax: 3500 },
      { name: "Charm Bracelet", weight: 0.025, priceMin: 400, priceMax: 1800 },
    ],
